        ...
        <div className="space-y-6">
          ...
          <div className="border-r-4 border-[#A8511A] pr-4">
            <p className="text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
              منذ عام <strong className="text-[#A8511A]">1972</strong> ونحن نمنحك الأناقة بخامات راقية واختيارات فريدة من أقمشة الصوف، الكشمير، الجلابيات، والبدل الرجالية.
            </p>
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 space-y-4 text-right">
            <h2 className="text-2xl font-semibold text-[#A8511A] mb-4">معلومات التواصل</h2>
            ...
            <div className="p-3 rounded hover:bg-green-50 dark:hover:bg-green-900/20 transition-colors text-right">
              <div className="flex items-center justify-start gap-3 mb-2">
                <span className="text-gray-700 dark:text-gray-300 font-medium">واتساب:</span>
          ...
          {/* Company Values */}
          <div className="border-r-4 border-[#A8511A] pr-4">
            <h2 className="text-2xl font-semibold text-[#A8511A] mb-3">قيمنا</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                <h3 className="font-semibold text-[#A8511A] mb-2">الجودة العالية</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm">
                  نختار أفضل الخامات من مصادر موثوقة لضمان رضا عملائنا
                </p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                <h3 className="font-semibold text-[#A8511A] mb-2">الخدمة المتميزة</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm">
                  فريق عمل متخصص لمساعدتك في اختيار الأنسب لك
                </p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                <h3 className="font-semibold text-[#A8511A] mb-2">الأسعار التنافسية</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm">
                  نقدم أفضل الأسعار مع ضمان الجودة العالية
                </p>
              </div>
              <div className="bg-white dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-700">
                <h3 className="font-semibold text-[#A8511A] mb-2">الشحن السريع</h3>
                <p className="text-gray-600 dark:text-gray-300 text-sm">
