...
const FAQ = () => {
  return (
    <>
      <Helmet>
        <title>الأسئلة الشائعة - النوام للأقمشة</title>
        <meta
          name="description"
        ...
        <div className="space-y-6 text-right">
          ...
          <div className="space-y-4">
            ...
            <details className="border rounded-lg p-4 bg-white/60 dark:bg-white/5">
              ...
              <p className="mt-2 text-black/80 dark:text-white/80">
                نعم، نوفر الشحن إلى جميع محافظات مصر حتى باب البيت بفضل الله.
                متوسط وقت التوصيل يومان لمعظم المحافظات.
              </p>
            </details>
            ...
            <details className="border rounded-lg p-4 bg-white/60 dark:bg-white/5">
              ...
              <p className="mt-2 text-black/80 dark:text-white/80">
                للأسف لا يمكن المعاينة قبل الاستلام وذلك لحماية المنتج من التلف
                أو السرقة، حيث أن شركات الشحن تلغي مسؤوليتها في حالة الموافقة
                على المعاينة. لكن لا تقلق، نوفر لك ضمان الاستبدال أو الاسترجاع
                بعد استلام المنتج إذا لم يكن مطابقاً للتوقعات.
              </p>
            </details>
          </div>
          ...
          <div className="space-y-4 pt-6">
            ...
            <details className="border rounded-lg p-4 bg-white/60 dark:bg-white/5">
              ...
              <p className="mt-2 text-black/80 dark:text-white/80">
                عند اختيار "الدفع عند الاستلام"، نحجز عربون ١٠٪ من إجمالي قيمة
                الطلبية قبل الشحن، ثم تقوم بدفع المبلغ المتبقي عند استلام
                الطلبية.
              </p>
            </details>
          </div>
          ...
          <div className="space-y-4 pt-6">
            ...
            <details className="border rounded-lg p-4 bg-white/60 dark:bg-white/5">
              ...
              <p className="mt-2 text-black/80 dark:text-white/80">
                نعم، نوفر خدمة الاستبدال والاسترجاع مع ضمان جودة المنتج لضمان
                رضاك التام عن شرائك.
              </p>
            </details>
          </div>
          ...
          <div className="space-y-4 pt-6">
            ...
            <details className="border rounded-lg p-4 bg-white/60 dark:bg-white/5">
              ...
              <p className="mt-2 text-black/80 dark:text-white/80">
                جميع طلباتنا مغلقة بشكل آمن ومحكم. في حال وجود أي استفسار عن
                المنتج بعد الاستلام، يمكنك التواصل معنا على الواتساب وسنقوم
                بمساعدتك على الفور.
              </p>
            </details>
          </div>
